 ...
 <h3 style="color: red"> ${msg}</h3>
    ...
    <br><br>
       ...
       <form class="form-size" action="./authenticate" method="post">
            <input type="text" class="form-control margin-bot tom-input" name="id" placeholder="Enter ID"/>
            ...
            <div class="row">
                ...
                <a href="../employee/create" style="color: white !important">Create Account</a></button>
