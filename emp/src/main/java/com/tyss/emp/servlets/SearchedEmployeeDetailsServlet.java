	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session == null) {
			...
			if (bean != null) {
				...
				out.print(
						"<div class=\"search col-2\"><form action=\"./search\"> <input type=\"text\" placeholder=\"Search\" name=\"search\"/></form></div>         ");
				out.print(
						"<div class=\"col-3\"><a href=\"login.html?loged=out\"><span class=\"logout\" style=\"margin-left: 70%;\">Logout</span></a></div> ");
				out.print("</div>     ");
				out.print("</div>     ");
				out.print("<br><br>   ");
